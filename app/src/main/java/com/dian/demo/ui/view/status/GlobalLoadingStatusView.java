...
import static com.dian.demo.ui.view.status.Gloading.STATUS_EMPTY_DATA;
import static com.dian.demo.ui.view.status.Gloading.STATUS_LOADING;
import static com.dian.demo.ui.view.status.Gloading.STATUS_LOAD_FAILED;
import static com.dian.demo.ui.view.status.Gloading.STATUS_LOAD_SUCCESS;
import static com.dian.demo.ui.view.status.Gloading.STATUS_TASK_OVER;
...
public class GlobalLoadingStatusView extends LinearLayout implements View.OnClickListener {
    ...
    public void setStatus(int status, @NotNull String msg) {
        ...
        int image = R.mipmap.icon_loading;
        ...
        switch (status) {
            ...
            case STATUS_LOAD_FAILED:
                ...
                image = R.mipmap.loading_no_network;
            ...
            case STATUS_TASK_OVER:
                ...
                image = R.mipmap.state_complete_all;
                mTextView.setText(str);
                break;
            default:
                break;
        ...
        LogUtil.d("setVisibility %s", String.valueOf(show));
