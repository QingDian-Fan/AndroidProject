package com.dian.demo.ui.titlebar;
 ...
 * https://gitee.com/swjt-hy/android-titlebar
 */
...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, ScreenUtils.dp2PxInt(context, 15));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextSize = array.getDimension(R.styleable.CommonTitleBar_centerTextSize, ScreenUtils.dp2PxInt(context, 16));
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            ivSearch.setImageResource(R.mipmap.comm_titlebar_search_normal);
            ...
            if (centerSearchRightType == TYPE_CENTER_SEARCH_RIGHT_VOICE) {
                ivVoice.setImageResource(R.mipmap.comm_titlebar_voice);
            } else {
                ivVoice.setImageResource(R.mipmap.comm_titlebar_delete_normal);
            ...
            if (!centerSearchEditable) {
                ...
                etSearchHint.setOnClickListener(v -> etSearchHint.setCursorVisible(true));
            }
            etSearchHint.setCursorVisible(false);
...
//            }
    ...
    public void setCenterText(CharSequence textString) {
        tvCenter.setText(textString);
    }

    public void setLeftVisibility(int visibleType) {
        if (leftType == TYPE_LEFT_TEXTVIEW && tvLeft != null) {
            tvLeft.setVisibility(visibleType);
        } else if (leftType == TYPE_LEFT_IMAGEBUTTON && btnLeft != null) {
            btnLeft.setVisibility(visibleType);
        } else if (leftType == TYPE_LEFT_CUSTOM_VIEW && viewCustomLeft != null) {
            viewCustomLeft.setVisibility(visibleType);
        }
    }
