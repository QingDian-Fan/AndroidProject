...
import com.dian.demo.ui.view.status.Gloading.Adapter
...
class Gloading  constructor() {
    ...
    interface Adapter {
         ...
         * @see Holder
         */
        fun getView(holder: Holder?, convertView: View?, status: Int, msg: String): View?
    }
    ...
    class Holder(
        ...
        fun showEmpty(msg: String = "") {
            showLoadingStatus(STATUS_EMPTY_DATA, msg)
        }

        fun showTaskOver() {
            showLoadingStatus(STATUS_TASK_OVER)
        }
         ...
         * @see .showEmpty
         */
        private fun showLoadingStatus(status: Int, msg: String = "") {
