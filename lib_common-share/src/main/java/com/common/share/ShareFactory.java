...
import com.common.share.channel.CustomChannel;
import com.common.share.channel.QQChannel;
import com.common.share.channel.WeChatChannel;
import com.common.share.channel.WeiBoChannel;
...
public class ShareFactory {
    ...
    public static void sendSuccessAction(int channel) {
        ...
        intent.setPackage(Utils.INSTANCE.getAppContext().getPackageName());
        Utils.INSTANCE.getAppContext().sendBroadcast(intent);
    }
