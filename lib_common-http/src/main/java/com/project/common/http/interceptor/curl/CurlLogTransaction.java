package com.project.common.http.interceptor.curl;

import android.net.Uri;


import com.google.gson.reflect.TypeToken;
import com.project.common.http.gson.GsonFactory;
...
public class CurlLogTransaction {
    ...
    public void setRequestHeaders(List<HttpHeader> headers) {
        requestHeaders = GsonFactory.getSingletonGson().toJson(headers);
    }


    public List<HttpHeader> getRequestHeaders() {
        return GsonFactory.getSingletonGson().fromJson(requestHeaders,
