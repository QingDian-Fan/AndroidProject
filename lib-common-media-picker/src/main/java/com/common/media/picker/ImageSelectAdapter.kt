...
import com.common.media.picker.databinding.ItemImageSelectBinding
import com.common.media.picker.ImageSelectAdapter.*
...
class ImageSelectAdapter(
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        with(holder) {
            ...
            if (isMulti) {
                binding.cbSingleImageSelectCheck.visibility = View.GONE
                binding.cbMultiImageSelectCheck.visibility = View.VISIBLE
                ...
                binding.cbSingleImageSelectCheck.visibility = View.VISIBLE
                binding.cbMultiImageSelectCheck.visibility = View.GONE
                binding.cbSingleImageSelectCheck.isChecked = selectList.contains(dataList[position])
            }


            // 视频项展示播放角标
            binding.ivVideoFlag.isVisible = videoPaths.contains(dataList[position])
