...
class LifecycleLogger {
    ...
    private inner class ActivityLifecycleCallback : Application.ActivityLifecycleCallbacks {

        private val fragmentLifecycleCallback = FragmentLifecycleCallback()
    ...
    private fun log(any: Any, state: String) {
        LogUtil.e(String.format("%s %s", any.javaClass.simpleName, state))
    }
}