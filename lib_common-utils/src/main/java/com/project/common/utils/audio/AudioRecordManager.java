package com.project.common.utils.audio;
...
public class AudioRecordManager {
    ...
    private final AudioParams DEFAULT_FORMAT = new AudioParams(16000, 1, 16);
    ...
    private void startRecord(String filePath, AudioParams params, RecordCallback callback) {
    ...
    private void startRecord(AudioParams params, RecordCallback callback) {
        ...
        if (ActivityCompat.checkSelfPermission(ProjectApplication.getAppContext(),Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED){
            Toast.makeText(ProjectApplication.getAppContext(),"请赋予RECORD_AUDIO权限",Toast.LENGTH_LONG).show();
            return;
        }
        //创建Record对象
